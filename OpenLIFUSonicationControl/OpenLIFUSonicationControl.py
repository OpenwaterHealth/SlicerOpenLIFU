...
class OpenLIFUSonicationControlLogic(ScriptedLoadableModuleLogic):
    ...
    def on_lifu_device_connected(self, *args, **kwargs):
        print("on_lifu_device_connected called in sonication control module. The arguments given in were:") # TODO: Remove in rebase before merging
        print("Positional arguments:", args) # TODO: Remove in rebase before merging
        print("Keyword arguments:", kwargs) # TODO: Remove in rebase before merging
        for f in self._on_lifu_device_connected_callbacks:
            f()

    def on_lifu_device_disconnected(self, *args, **kwargs):
        print("on_lifu_device_disconnected called in sonication control module. The arguments given in were:") # TODO: Remove in rebase before merging
        print("Positional arguments:", args) # TODO: Remove in rebase before merging
        print("Keyword arguments:", kwargs) # TODO: Remove in rebase before merging
