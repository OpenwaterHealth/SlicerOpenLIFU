...
class KeyValueAsAbstractClassDialog(KeyValueDialog):
...
class DictTableWidget(qt.QWidget):
    ...
    def _open_add_dialog(self):
        ...
        if self.val_type is str:
            addDlg = KeyValueDialog(self.key_name, self.val_name, existing_keys)
        else:
            addDlg = KeyValueAsAbstractClassDialog(self.key_name, self.val_name, self.val_type, existing_keys)
